...
# =====================================================================
    ...
    # --- INJECTION DU STYLE CSS PARFAITEMENT CIBLÉ (HACK ANCRE CLASSE HTML) ---
    st.markdown("""
    <style>
        /* Espacement global pour éviter le chevauchement sous la barre fixe */
        .main .block-container {
            padding-top: 90px !important;
            max-width: 100% !important;
        }
        
        /* ICI, ON CIBLE UNIQUEMENT LE STRADIO SITUÉ DIRECTEMENT APRÈS NOTRE ANCRE DIV */
        div.barre-navigation-fixe + div[data-testid="stRadio"] {
        ...
        /* Masquer le label uniquement pour NOTRE menu principal */
        div.barre-navigation-fixe + div[data-testid="stRadio"] label[data-testid="stWidgetLabel"] {
            display: none !important;
        }

        /* Alignement horizontal uniquement pour le menu principal */
        div.barre-navigation-fixe + div[data-testid="stRadio"] div[role="radiogroup"] {
        ...
        /* Look design des bulles uniquement pour le menu principal */
        div.barre-navigation-fixe + div[data-testid="stRadio"] div[role="radiogroup"] label {
            flex: 1 !important;
        ...
        /* Supprimer les ronds radio uniquement pour le menu principal */
        div.barre-navigation-fixe + div[data-testid="stRadio"] div[role="radiogroup"] label div[data-testid="stMarkdownContainer"]::before,
        div.barre-navigation-fixe + div[data-testid="stRadio"] [data-testid="stWidgetRadioCircle"] {
            display: none !important;
        }

        /* Taille des emojis uniquement pour le menu principal */
        div.barre-navigation-fixe + div[data-testid="stRadio"] div[role="radiogroup"] label p {
            font-size: 20px !important;
            margin: 0 !important;
            padding: 0 !important;
        }

        /* Style actif de l'onglet sélectionné uniquement pour le menu principal */
        div.barre-navigation-fixe + div[data-testid="stRadio"] div[role="radiogroup"] label:has(input:checked),
        div.barre-navigation-fixe + div[data-testid="stRadio"] div[role="radiogroup"] label[data-checked="true"] {
