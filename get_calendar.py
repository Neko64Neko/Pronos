...
try:
    ...
    print(f"Vérification des secrets -> URL Supabase présente : {bool(SUPABASE_URL)}, Clé API présente : {bool(RAPIDAPI_KEY)}")

    if not SUPABASE_URL or not SUPABASE_KEY or not RAPIDAPI_KEY:
        raise ValueError("Il manque un ou plusieurs secrets dans les variables d'environnement GitHub Actions !")
    ...
    def run_calendar():
        ...
        # Ajout d'un timeout de 30 secondes pour éviter le blocage infini
        ...
        try:
            ...
            if res.data and len(res.data) > 0:
                ...
                print("AVERTISSEMENT : Aucune ligne trouvée dans la table Configuration.")
